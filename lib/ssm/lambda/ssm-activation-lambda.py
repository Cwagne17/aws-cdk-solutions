...
def lambda_handler(event, context):
    ...
    if (ssmactivresponse["ResponseMetadata"]["HTTPStatusCode"]) == 200 and (
        ssmactivresponse["ActivationList"]
    ) != []:
        ...
        remresponse = ssmclient.delete_activation(ActivationId=activid)
        ...
        "body": json.dumps(
            {
                ...
                "ActivationId": apiresponse["ActivationId"],
            }
        ),
    }
